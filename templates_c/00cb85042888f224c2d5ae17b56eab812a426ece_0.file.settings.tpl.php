...
/* Smarty version 3.1.32, created on 2019-04-20 10:29:14
  from '/var/www/html/versions/2.0.1/templates/v1/Main/settings.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.32',
  'unifunc' => 'content_5cbaf47a59fe65_55209250',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '00cb85042888f224c2d5ae17b56eab812a426ece' => 
    array (
      0 => '/var/www/html/versions/2.0.1/templates/v1/Main/settings.tpl',
      1 => 1555756142,
      2 => 'file',
    ),
  ),
...
function content_5cbaf47a59fe65_55209250 (Smarty_Internal_Template $_smarty_tpl) {
?> 
        ...
        $(".version_check").on('click',function(e) {
            ...
            $.ajax({
                ...
                success: function(data){
                    ...
                    if(data.version != 0){
                        $(".version_check").html("");
                        $(".loading").html("<p><b>"+data.version+"</b> Version is Released. You are outdated</p>  <a id='1' class='doUpdate'>UPDATE</a>");
